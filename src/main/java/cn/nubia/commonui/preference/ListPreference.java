...
public class ListPreference extends DialogPreference {
    ...
    public ListPreference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, (int[]) ReflectUtils.getStyleable("ListPreference"), defStyleAttr, defStyleRes);
        this.mEntries = a.getTextArray(((Integer) ReflectUtils.getStyleable("ListPreference_entries")).intValue());
        this.mEntryValues = a.getTextArray(((Integer) ReflectUtils.getStyleable("ListPreference_entryValues")).intValue());
        a.recycle();
        TypedArray a2 = context.obtainStyledAttributes(attrs, (int[]) ReflectUtils.getStyleable("Preference"), defStyleAttr, defStyleRes);
        this.mSummary = a2.getString(((Integer) ReflectUtils.getStyleable("Preference_summary")).intValue());
        a2.recycle();
        setLayoutResource(R.layout.nubia_right_summary_preference);
    }
    ...
    public void setValueIndex(int index) {
        if (this.mEntryValues != null && this.mEntryValues[index] != null) {
    ...
    public int findIndexOfValue(String value) {
        if (!(value == null || this.mEntryValues == null)) {
            for (int i = this.mEntryValues.length - 1; i >= 0; i--) {
                if (this.mEntryValues[i] != null && this.mEntryValues[i].equals(value)) {
                    return i;
                }
            }
        }
    ...
    public void onDialogClosed(boolean positiveResult) {
        ...
        if (positiveResult && this.mClickedDialogEntryIndex >= 0 && this.mEntryValues != null && this.mClickedDialogEntryIndex < this.mEntryValues.length && this.mEntryValues[this.mClickedDialogEntryIndex] != null) {
