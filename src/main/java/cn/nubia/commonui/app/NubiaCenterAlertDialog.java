...
public class NubiaCenterAlertDialog extends Dialog implements DialogInterface {
    public static final int LAYOUT_HINT_NONE = 0;
    public static final int LAYOUT_HINT_SIDE = 1;
    /* access modifiers changed from: private */
    public NubiaCenterAlertController mAlert;
    ...
    public static class Builder {
        ...
        public Builder(Context context) {
            this(context, NubiaCenterAlertDialog.resolveDialogTheme(context, 0));
        }

        public Builder(Context context, int theme) {
            this.P = new AlertParams(new ContextThemeWrapper(context, NubiaCenterAlertDialog.resolveDialogTheme(context, theme)));
            this.mTheme = theme;
        }
        ...
        public NubiaCenterAlertDialog create() {
            NubiaCenterAlertDialog dialog = new NubiaCenterAlertDialog(this.P.mContext, this.mTheme, false);
        ...
        public NubiaCenterAlertDialog show() {
            NubiaCenterAlertDialog dialog = create();
            dialog.show();
            return dialog;
        }
    }
    ...
    protected NubiaCenterAlertDialog(Context context, int theme) {
        this(context, theme, true);
    }

    NubiaCenterAlertDialog(Context context, int theme, boolean createThemeContextWrapper) {
        ...
        this.mAlert = new NubiaCenterAlertController(getContext(), this, getWindow());
        getWindow().setGravity(16);
    }

    protected NubiaCenterAlertDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
        super(context, resolveDialogTheme(context, 0));
        ReflectUtils.invoke(getWindow(), "alwaysReadCloseOnTouchAttr", false, false);
        setCancelable(cancelable);
        setOnCancelListener(cancelListener);
        this.mAlert = new NubiaCenterAlertController(context, this, getWindow());
        getWindow().setGravity(16);
    }
