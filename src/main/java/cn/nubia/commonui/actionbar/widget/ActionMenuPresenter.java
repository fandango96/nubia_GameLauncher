...
import cn.nubia.commonui.actionbar.internal.view.menu.ActionMenuItemView.PopupCallback;
import cn.nubia.commonui.actionbar.internal.view.menu.BaseMenuPresenter;
...
public class ActionMenuPresenter extends BaseMenuPresenter implements SubUiVisibilityListener {
    ...
    public ActionMenuPresenter(Context context) {
        super(context, R.layout.nubia_abc_action_menu_layout, R.layout.abc_action_menu_item_layout);
    }
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        dismissActionButtonPopup();
    }

    public void setWidthLimit(int width, boolean strict) {
        this.mWidthLimit = width;
        this.mStrictWidthLimit = false;
    ...
    private void dismissActionButtonPopup() {
        if (this.mActionButtonPopup != null) {
            this.mActionButtonPopup.dismiss();
        }
    }
