...
import cn.nubia.commonui.actionbar.internal.view.menu.MenuPresenter.Callback;
...
import cn.nubia.commonui.actionbar.internal.widget.RtlSpacingHelper;
...
import cn.nubia.commonui.actionbar.internal.widget.ToolbarWidgetWrapper;
...
public class Toolbar extends ViewGroup {
    ...
    private final cn.nubia.commonui.actionbar.widget.ActionMenuView.OnMenuItemClickListener mMenuViewItemClickListener;
    ...
    public static class LayoutParams extends cn.nubia.commonui.actionbar.app.ActionBar.LayoutParams {
        ...
        public LayoutParams(LayoutParams source) {
            super((cn.nubia.commonui.actionbar.app.ActionBar.LayoutParams) source);
            this.mViewType = 0;
            this.mViewType = source.mViewType;
        }

        public LayoutParams(cn.nubia.commonui.actionbar.app.ActionBar.LayoutParams source) {
            super(source);
            this.mViewType = 0;
        }
    ...
    public Toolbar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        AnonymousClass1 r0 = new cn.nubia.commonui.actionbar.widget.ActionMenuView.OnMenuItemClickListener() {
    ...
    public LayoutParams generateLayoutParams(android.view.ViewGroup.LayoutParams p) {
        ...
        if (p instanceof cn.nubia.commonui.actionbar.app.ActionBar.LayoutParams) {
            return new LayoutParams((cn.nubia.commonui.actionbar.app.ActionBar.LayoutParams) p);
        }
