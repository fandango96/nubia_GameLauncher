...
import cn.nubia.commonui.actionbar.internal.widget.AppCompatPopupWindow;
import cn.nubia.commonui.actionbar.internal.widget.ListViewCompat;
...
public class ListPopupWindow {
    ...
    public ListPopupWindow(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mListItemExpandMaximum = ConstraintAnchor.ANY_GROUP;
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        if (isShowing() && keyCode != 62 && (this.mDropDownList.getSelectedItemPosition() >= 0 || !isConfirmKey(keyCode))) {
            ...
            int firstItem = ConstraintAnchor.ANY_GROUP;
