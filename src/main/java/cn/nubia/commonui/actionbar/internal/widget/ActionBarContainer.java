...
import cn.nubia.commonui.actionbar.internal.VersionUtils;
...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attrs) {
        ...
        if (getId() == R.id.split_action_bar) {
            this.mIsSplit = true;
            this.mHeight = context.getResources().getDimensionPixelSize(R.dimen.nubia_action_bar_split_height);
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.mActionBarView != null) {
            ...
            if (this.mTabContainer != null && this.mTabContainer.getVisibility() != 8 && mode != 1073741824) {
                ...
                setMeasuredDimension(getMeasuredWidth(), Math.min(getMeasuredHeightWithMargins(this.mTabContainer) + topMarginForTabs, mode == Integer.MIN_VALUE ? MeasureSpec.getSize(heightMeasureSpec) : ConstraintAnchor.ANY_GROUP));
            }
        }
    }
