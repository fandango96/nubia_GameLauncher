...
import cn.nubia.commonui.actionbar.app.ActionBar.LayoutParams;
import cn.nubia.commonui.actionbar.app.ActionBar.OnMenuVisibilityListener;
import cn.nubia.commonui.actionbar.app.ActionBar.OnNavigationListener;
import cn.nubia.commonui.actionbar.app.ActionBar.Tab;
import cn.nubia.commonui.actionbar.app.ActionBar.TabListener;
import cn.nubia.commonui.actionbar.internal.view.ActionBarPolicy;
...
import cn.nubia.commonui.actionbar.internal.view.menu.MenuPopupHelper;
...
import cn.nubia.commonui.actionbar.internal.widget.ActionBarOverlayLayout.ActionBarVisibilityCallback;
import cn.nubia.commonui.actionbar.internal.widget.DecorToolbar;
...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    private boolean mNeedHideSplitView = false;
    ...
    public class ActionModeImpl extends ActionMode implements MenuBuilder.Callback {
        ...
        public void setCloseMenuVisibility(int visibility) {
            WindowDecorActionBar.this.mContextView.setCloseMenuVisibility(visibility);
        }
    ...
    public void setContextDisplayMode(int mContextDisplayMode2) {
        this.mContextDisplayMode = mContextDisplayMode2;
    }

    public void setNeedHideSplitView(boolean needHideSplitView) {
        this.mNeedHideSplitView = needHideSplitView;
    }
    ...
    private void init(View decor) {
        ...
        if (this.mSplitView != null) {
            this.mDecorToolbar.setSplitView(this.mSplitView);
            ...
            this.mContextView.setSplitToolbar(splitActionBar);
            this.mContextView.setSplitWhenNarrow(splitWhenNarrow);
        }
        this.mContext = this.mDecorToolbar.getContext();
        if (UiUtils.isNubiaUi(this.mContext)) {
    ...
    private void setHasEmbeddedTabs(boolean hasEmbeddedTabs) {
        ...
        if (this.mTabScrollView != null && !this.mShowingForMode) {
            if (isInTabMode) {
    ...
    private void updateVisibility(boolean fromSystem) {
        if (checkShowingFlags(this.mHiddenByApp, this.mHiddenBySystem, this.mShowingForMode)) {
            if (!this.mNowShowing) {
                ...
                doShow(fromSystem);
            } else if (!this.mShowingForMode && this.mNeedHideSplitView) {
                this.mNeedHideSplitView = false;
                hideSplitView();
            }
    ...
    public void hideSplitView() {
        if (this.mContextDisplayMode == 1 && this.mSplitView != null) {
    ...
    public void doShow(boolean fromSystem) {
        ...
        this.mDecorToolbar.setActionBarShowOrHide(true);
    ...
    public void doHide(boolean fromSystem) {
        ...
        this.mDecorToolbar.setActionBarShowOrHide(false);
        if (this.mCurWindowVisibility != 0 || !ALLOW_SHOW_HIDE_ANIMATIONS || (!this.mShowHideAnimationEnabled && !fromSystem)) {
    ...
    public View getSplitActionBarView() {
        if (this.mSplitView != null) {
    ...
    public View getActionBarContextView() {
