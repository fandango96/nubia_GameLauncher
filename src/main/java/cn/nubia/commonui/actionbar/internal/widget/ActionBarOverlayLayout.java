...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (!(!this.mDecorToolbar.isSplit() || this.mActionBarBottom == null || this.mActionBarBottom.getVisibility() == 8)) {
    ...
    private boolean shouldHideActionBarOnFling(float velocityX, float velocityY) {
        this.mFlingEstimator.fling(0, 0, 0, (int) velocityY, 0, 0, Integer.MIN_VALUE, ConstraintAnchor.ANY_GROUP);
