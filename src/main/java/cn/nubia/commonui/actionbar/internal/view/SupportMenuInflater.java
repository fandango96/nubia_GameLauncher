...
import cn.nubia.commonui.actionbar.internal.view.menu.MenuItemWrapperICS;
...
public class SupportMenuInflater extends MenuInflater {
    ...
    private static final String LOG_TAG = "NubiaWidget";
    ...
    private class MenuState {
        ...
        public void readItem(AttributeSet attrs) {
            ...
            this.itemActionViewClassName = a.getString(R.styleable.MenuItem_android_actionViewClass);
            this.itemActionProviderClassName = a.getString(R.styleable.MenuItem_actionProviderClass);
            this.itemLayoutPadding = a.getDimensionPixelOffset(R.styleable.MenuItem_layout_padding, SupportMenuInflater.this.mContext.getResources().getDimensionPixelOffset(R.dimen.nubia_action_bar_menu_item_layout_padding));
        ...
        private void setItem(MenuItem item) {
            ...
            if (item instanceof MenuItemImpl) {
                ((MenuItemImpl) item).setLayoutPaddingPixel(Integer.valueOf(this.itemLayoutPadding));
            }
