...
public interface IGameHandleService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IGameHandleService {
        private static final String DESCRIPTOR = "cn.nubia.gamelauncher.gamehandle.IGameHandleService";
        ...
        public static IGameHandleService asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
            if (iin == null || !(iin instanceof IGameHandleService)) {
                return new Proxy(obj);
            }
            return (IGameHandleService) iin;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    boolean _result = isGameHandleConnected();
                ...
                case 2:
                    data.enforceInterface(DESCRIPTOR);
                    boolean _result2 = connect(data.readString());
                    reply.writeNoException();
                    if (_result2) {
                        i = 1;
                    }
