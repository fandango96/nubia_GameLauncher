...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    public static abstract class LayoutManager {
        ...
        public boolean shouldReMeasureChild(View child, int widthSpec, int heightSpec, LayoutParams lp) {
            if (!this.mMeasurementCacheEnabled || !isMeasurementUpToDate(child.getMeasuredWidth(), widthSpec, lp.width) || !isMeasurementUpToDate(child.getMeasuredHeight(), heightSpec, lp.height)) {
                return RecyclerView.OPTS_INPUT;
            }
            return false;
        }
    ...
    public final class Recycler {
        ...
        public ViewHolder tryGetViewHolderForPositionByDeadline(int position, boolean dryRun, long deadlineNs) {
            ...
            rvLayoutParams.mViewHolder = holder;
            rvLayoutParams.mPendingInvalidate = (!fromScrapOrHiddenOrCache || !bound) ? false : RecyclerView.OPTS_INPUT;
            return holder;
        }
        ...
        public void recycleCachedViewAt(int cachedViewIndex) {
            addViewHolderToRecycledViewPool((ViewHolder) this.mCachedViews.get(cachedViewIndex), RecyclerView.OPTS_INPUT);
    ...
    class ViewFlinger implements Runnable {
        ...
        public void run() {
            ...
            if (scroller.computeScrollOffset()) {
                ...
                boolean fullyConsumedAny = (!(dx == 0 && dy == 0) && !((dx == 0 || !RecyclerView.this.mLayout.canScrollHorizontally() || hresult != dx) ? false : RecyclerView.OPTS_INPUT) && !((dy == 0 || !RecyclerView.this.mLayout.canScrollVertically() || vresult != dy) ? false : RecyclerView.OPTS_INPUT)) ? false : RecyclerView.OPTS_INPUT;
        ...
        public void fling(int velocityX, int velocityY) {
            ...
            this.mLastFlingY = 0;
            this.mLastFlingX = 0;
            this.mScroller.fling(0, 0, velocityX, velocityY, Integer.MIN_VALUE, ConstraintAnchor.ANY_GROUP, Integer.MIN_VALUE, ConstraintAnchor.ANY_GROUP);
            postOnAnimation();
        }
    ...
    public boolean removeAnimatingView(View view) {
        ...
        resumeRequestLayout(!removed ? OPTS_INPUT : false);
        return removed;
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:100:0x02e2, code lost:
        if (fling((int) r21, (int) r23) == false) goto L_0x02e4;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public boolean onTouchEvent(android.view.MotionEvent r26) {
        ...
        L_0x000d:
            return r2
        L_0x000e:
            boolean r2 = r25.dispatchOnItemTouch(r26)
        ...
        L_0x0019:
            r0 = r25
            android.support.v7.widget.RecyclerView$LayoutManager r2 = r0.mLayout
        ...
        L_0x0021:
            ...
            r0 = r25
            android.support.v7.widget.RecyclerView$LayoutManager r2 = r0.mLayout
            boolean r11 = r2.canScrollVertically()
            r0 = r25
        ...
        L_0x003f:
            r12 = 0
            android.view.MotionEvent r19 = android.view.MotionEvent.obtain(r26)
            int r8 = r26.getActionMasked()
            int r9 = r26.getActionIndex()
            if (r8 != 0) goto L_0x005e
            r0 = r25
            int[] r2 = r0.mNestedOffsets
            r5 = 0
            r0 = r25
            int[] r6 = r0.mNestedOffsets
            r7 = 1
            r24 = 0
            r6[r7] = r24
            r2[r5] = r24
        ...
        L_0x00fe:
            ...
            r0 = r26
            int r13 = r0.findPointerIndex(r2)
            if (r13 >= 0) goto L_0x0139
            java.lang.String r2 = "RecyclerView"
            java.lang.StringBuilder r5 = new java.lang.StringBuilder
            r5.<init>()
            java.lang.String r6 = "Error processing scroll; pointer index for id "
            java.lang.StringBuilder r5 = r5.append(r6)
            r0 = r25
            int r6 = r0.mScrollPointerId
            java.lang.StringBuilder r5 = r5.append(r6)
            java.lang.String r6 = " not found. Did any MotionEvents get skipped?"
            java.lang.StringBuilder r5 = r5.append(r6)
        ...
        L_0x0139:
            r0 = r26
            float r2 = r0.getX(r13)
            r5 = 1056964608(0x3f000000, float:0.5)
            float r2 = r2 + r5
            int r0 = (int) r2
            r20 = r0
            r0 = r26
            float r2 = r0.getY(r13)
            r5 = 1056964608(0x3f000000, float:0.5)
            float r2 = r2 + r5
            int r0 = (int) r2
            r22 = r0
        ...
        L_0x0228:
            r0 = r25
            r1 = r19
            boolean r2 = r0.scrollByInternal(r5, r2, r1)
        ...
        L_0x023a:
            r0 = r25
            android.support.v7.widget.GapWorker r2 = r0.mGapWorker
    ...
    private void dispatchLayoutStep1() {
        ...
        processAdapterUpdatesAndSetAnimationFlags();
        saveFocusInfo();
        this.mState.mTrackOldChangeHolders = (!this.mState.mRunSimpleAnimations || !this.mItemsChanged) ? false : OPTS_INPUT;
        this.mItemsChanged = false;
        this.mItemsAddedOrRemoved = false;
    ...
    private void findMinMaxChildLayoutPositions(int[] into) {
        ...
        int minPositionPreLayout = ConstraintAnchor.ANY_GROUP;
    ...
    public boolean checkLayoutParams(android.view.ViewGroup.LayoutParams p) {
        if (!(p instanceof LayoutParams) || !this.mLayout.checkLayoutParams((LayoutParams) p)) {
            return false;
        }
        return OPTS_INPUT;
    }
